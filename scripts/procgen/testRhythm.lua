...
local pattern = {
	...
	{	-- pattern[3], 		=	. , 3 , 2 , 1 , * * .
		...
		extra hits = { -- default is an empty array of extra hits
			0.5 -- one extra hit, a half beat later. uses the same wait buffer
		}
	} 
}
...
local beats = {
	...
	{}, 							-- 3
	{}, 							-- and
	{ primes = { pattern[1] } }, 	-- 4		this prime will have 
